...
namespace AqualLifeStyle.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AqualLifeStyleConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AqualLifeStyleDbContext context)
        {
            _context = context;
        }
